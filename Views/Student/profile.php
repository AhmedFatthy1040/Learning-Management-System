                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary fw-bold m-0">Courses</h6>
                                </div>
                                <div class="card-body">
                                    <?php
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"
                                                                ...
                                                                placeholder="<?php echo $_SESSION["UserFirstName"] . "_" . $_SESSION["UserLastName"] ?>"
                                                                name="username"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"
                                                                ...
                                                                placeholder="<?php echo $_SESSION["UserFirstName"] ?>"
                                                                name="fname"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"
                                                                ...
                                                                placeholder="<?php echo $_SESSION["UserLastName"] ?>"
                                                                name="lname"></div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"
                                                                ...
                                                                placeholder="<?php echo $_SESSION["UserNationality"] ?>"
                                                                name="Country"></div>
                                                    </div>
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label"
                                                                ...
                                                                placeholder="<?php echo $_SESSION["UserPhone"] ?>"
