<?php
    ...
    if (isset($_POST["ExamDuration"]) && isset($_POST["CourseID"])) {
        if (!empty($_POST["ExamDuration"]) && !empty($_POST["CourseID"])) {
            $Exam = new Exam();
            $Exam->setExamDuration($_POST["ExamDuration"]);
            $Exam->setCourseID($_POST["CourseID"]);
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="view_courses.php"><i class="fas fa-book-open"></i><span>View Courses</span></a></li>
                                    ...
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-6 mb-3 mb-sm-0"><input class="form-control form-control-user" type="text" id="exampleCourseID" placeholder="CourseID" name="CourseID"></div>
                                            </div>
