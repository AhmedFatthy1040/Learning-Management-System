<?php
    ...
    if (isset($_POST['delete'])) {
        ...
        $Controller->DeleteFromTable("question", $DeleteID);
    }
?>
...
<head>
    ...
    <title>Manage Questions - LMS</title>
        ...
        <div id="content">
                ...
                <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
                    ...
                    <ul class="navbar-nav flex-nowrap ms-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><?php echo $_SESSION["AdminName"] ?></span><img class="border rounded-circle img-profile" src="../assets/img/avatars/gear.png"></a>
            ...
            <div class="container-fluid">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-dark mb-0">Manage Question Bank</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="add-answer.php"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Add Answer to a Question</a>
                </div>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Question Info</p>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <table class="table my-0" id="dataTable">
                                ...
                                foreach ($Questions as $Question) {
                                    ...
                                    <tr>
                                        ...
                                        <td>   <form action="QuestionBank.php" method="POST">
                                                <input type="hidden" name="DeleteID" value="<?php echo $Question['id']; ?>">
