        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex justify-content-between align-items-center mb-4">
                    <h3 class="text-dark mb-0">Courses</h3><a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="add-course.php"><i class="fas fa-download fa-sm text-white-50"></i>&nbsp;Add Course</a>
                </div>
                        ...
                        <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <td>   <form action="Courses.php" method="POST">
