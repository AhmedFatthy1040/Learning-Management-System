...
$sql = 'SELECT id, duration, course_id FROM exam ORDER BY course_id;';
...
if(isset($_POST['delete'])){
    ...
    $sql = "DELETE FROM exam WHERE id = $id_to_delete";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Delete Exam</h3><a
                            class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="add_exam.php"><i
                                class="fas fa-download fa-sm text-white-50"></i>&nbsp;Add Exam</a>
                    </div>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">Exam Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
