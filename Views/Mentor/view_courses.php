    ...
    <div class="d-flex flex-column" id="content-wrapper">
        <div id="content">
            ...
            <div class="container-fluid">
                <div>
                    <ul class="link_list">
                        <li class="link_item"><a href="add_lecture.php">Add Lecture</a></li>
                        <li class="link_item"><a href="delete_lecture.php">Delete Lecture</a></li>
                        <li class="link_item"><a href="add_exam.php">Add Exams</a></li>
                        <li class="link_item"><a href="delete_exam.php">Delete Exam</a></li>
                        <li class="link_item"><a href="add-question.php">Add Question</a></li>
                        <li class="link_item"><a href="add-answer.php">Add Answer</a></li>
                    </ul>
                </div>
